            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Select
                    onValueChange={(value) =>
                      form.setValue("doctorID", Number(value))
                    } // Set doctorID as number
                    defaultValue={field.value?.toString()} // Ensure value is a string for the Select
                  >
                    <SelectTrigger>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                {/*<FormMessage>{errors.medicalRecordFiles?.message}</FormMessage>*/}
                <FormMessage />
              </FormItem>
            )}
          />
